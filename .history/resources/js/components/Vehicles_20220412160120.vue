<template>
    ...
    <div class="mt-4">
      ...
      <div class="mt-1">
          <input v-mask="[mask]" v-model="plate" id="plate" name="plate" type="text" autocomplete="plate"
...
export default {
    ...
    computed:{
      mask(){
        ...
        if(this.plate.match(/^.{2}$/)){
          return 'XXX';
        }
        if(this.plate.match(/^.{3}$/)){
          return 'XXXX';
        }
        if(this.plate.match(/^.{4}$/)){
          return 'XXXX-#';
        }
        if(this.plate.match(/^.{4}-\d$/)){
          return 'XXXX-##';
        }
      },
      updatedVehicles(){
