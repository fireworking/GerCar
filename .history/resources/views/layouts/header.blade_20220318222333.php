        ...
        <div class="pt-5 pb-6 px-5">
          ...
          <div class="mt-16">
            <nav class="grid gap-y-8">
              ...
              <a href="/add-vehicle" class="-m-3 p-3 {{ $userType == 'company' ? 'hidden' : '' }} {{ $page == 'add_vehicle' ? 'border-2 border-orange-500 rounded-2xl text-orange-500' : 'text-gray-900' }} flex items-center rounded-md hover:bg-gray-50">
