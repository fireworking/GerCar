    ...
    <div class="min-h-full flex flex-col justify-center py-4 sm:py-8 sm:px-16 lg:px-20">
      ...
      <div class="sm:mt-2 sm:mx-auto sm:w-full sm:max-w-xl">
        <div class="bg-white py-2 sm:pb-4 sm:pt-1 px-4 shadow sm:rounded-lg sm:px-10">
          <form class="space-y-6" v-on:submit.prevent="submit" :action="window.location.href.replace('http://localhost/register-company')" method="POST">
            <slot name="csrf"></slot>
...
<script>
export default {
    props: ['states', 'cities', 'defineCities', 'submit', 'fields', 'v', 'serverErrors', 'hrefSubtitle'],
}
</script>