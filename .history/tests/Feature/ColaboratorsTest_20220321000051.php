...
class ColaboratorsTest extends TestCase
{
    ...
    public function test__only_companies_can_register_colabs(){
        $this->registerExampleCompany();
        Auth::logout();
        $this->registerExampleColaborator();
        $this->assertEquals(0, Colaborator::count());
        $this->post('/login', [
            'email' => 'ge@wilbur.com',
            'password' => 'ahjsdhjad'
        ]);
        ...
        $this->post('/register-colaborator', [
            'email' => 'gehaa@wilbur.com',
            'password' => 'ahjsdhjad'
        ]);
        $this->assertEquals(1, Colaborator::count());
    }
}
