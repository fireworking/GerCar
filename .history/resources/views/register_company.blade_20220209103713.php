          ...
          <form class="space-y-6" v-on:submit.prevent="submit" action="/register-company" method="POST">
            ...
            <div class="grid gap-y-6 gap-x-4 sm:grid-cols-6">
              ...
              <div class="sm:col-span-3">
                ...
                <select v-model="fields.city" id="city" name="city" autocomplete="city-name" class="mt-1 block w-full py-4 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm">
