<template>
    ...
    <div :class="'min-h-full flex flex-col justify-center ' + (logoValue ? 'py-16 ' : 'py-16 ') + 'sm:px-16 lg:px-20'">
          ...
          <form class="space-y-6" v-on:submit.prevent="submit" :action="currentUri" method="POST">
            ...
            <div class="grid gap-y-6 gap-x-4 sm:grid-cols-6">
              ...
              <div v-if="data.includes('plate')" class="sm:col-span-3">
                <text-input :server-errors="serverErrors" :fields="fields" field="plate" :vm="['AAA-#N##']">Licence Plate</text-input>
