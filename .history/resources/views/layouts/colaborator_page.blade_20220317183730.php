    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        <div class="flex justify-start lg:w-0 lg:flex-1">
          <a href="/">
            <img class="h-8 w-auto sm:h-16 border rounded-full border-orange-500 border-2" src="../img/car.png" alt="">
          </a>
        </div>
        ...
        <nav class="hidden md:flex space-x-10">
          ...
          <a href="/vehicles" class="text-base p-2 {{ $page == 'vehicles' ? 'border border-orange-500 rounded-2xl' : '' }} font-medium text-gray-500 hover:text-gray-900"> Vehicles </a>
          <a href="/add-vehicle" class="text-base p-2 {{ $page == 'add_vehicles' ? 'border border-orange-500 rounded-2xl' : '' }} font-medium text-gray-500 hover:text-gray-900"> Add Vehicle </a>
