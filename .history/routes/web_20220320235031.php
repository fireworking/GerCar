...
Route::get('/colaborator', [ColaboratorController::class, 'colaborator'])->middleware('');
Route::get('/fill-info', [ColaboratorController::class, 'fillInfoForm'])->middleware('');
Route::post('/fill-info', [ColaboratorController::class, 'fillInfo'])->middleware('');
