        ...
        <div class="pt-5 pb-6 px-5">
          ...
          <div class="mt-16">
            <nav class="grid gap-y-8">
              ...
              <a href="/add-vehicle" class="-m-3 p-3 {{ $userType == 'colaborator' ? 'hidden' : '' }} {{ $page == 'colaborators' ? 'border-2 border-orange-500 rounded-2xl text-orange-500' : '' }} flex items-center rounded-md hover:bg-gray-50">
                <svg class="h-6 w-6 text-orange-600"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  
