    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        <div class="flex justify-start lg:w-0 lg:flex-1">
          <a href="/">
            <img class="h-8 w-auto sm:h-16 border rounded-full border-orange-500" src="../img/car.png" alt="">
          </a>
        </div>
        ...
        <nav class="hidden md:flex space-x-10">
          ...
          <a href="/register-colaborator" class="text-base font-medium text-gray-500 hover:text-gray-900"> Colaborators </a>
          <a href="/vehicles" class="text-base font-medium text-gray-500 hover:text-gray-900"> Vehicles </a>
        ...
        <div class="pt-5 pb-6 px-5">
          ...
          <div class="mt-16">
            <nav class="grid gap-y-8">
              <a href="/register-colaborator" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
              ...
              <a href="/vehi" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
