...
Route::get('/register-colaborator', [ColaboratorController::class, 'create'])->middleware('company');
Route::post('/register-colaborator', [ColaboratorController::class, 'store'])->middleware('company');
...
Route::get('/add-vehicle', [VehicleController::class, 'create'])->middleware('colab');
Route::post('/add-vehicle', [VehicleController::class, 'store'])->middleware('colab');
Route::get('/vehicles', [VehicleController::class, 'index'])->middleware('auth')->name();
