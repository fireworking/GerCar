...
export default {
    ...
    watch: {
      plate(newPlate, oldPlate) {
        ...
        console.log(plate);
        plate = plate.replace(/\w/g, e => e[0].toUpperCase());
        console.log(plate);
        plate = plate.replace(/[A-Z]{4}/g, e => e[0].substring(0, -1) + '-');
        console.log(plate);
        plate = plate.replace(/-[A-Z]/g, e => e[0].substring(0, -1));
        console.log(plate);
        plate = plate.replace(/^-/g, e => e[0].substring(0, -1));
        console.log(plate);
        plate = plate.replace(/[^\w-]/g, e => e.substring(0, -1));
        console.log(plate);
        plate = plate.replace(/\d[A-Z]{1}/g, e => e.substring(0, -1));
        console.log(plate);
        this.plate = plate;
      }
    },
