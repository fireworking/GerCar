...
app.component('add-vehicle', require('./components/AddVehicle/AddVehicle.vue').default);
...
app.component('vehicles', require('./components/Vehicles.vue').default);
app.component('mobile-nav', require('./components/mobileNav.vue').default);
