...
<mobile-nav v-slot="{active, toggleNav}">
  <div class="relative bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        <div class="flex justify-start lg:w-0 lg:flex-1">
          <a href="/">
            <img class="h-16 w-auto sm:h-16 border-2 rounded-full border-orange-500 p-2" src="../img/car.png" alt="">
          </a>
        </div>
        <div class="-mr-2 -my-2 md:hidden">
          <button v-on:click="toggleNav" type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-orange-500" aria-expanded="false">
      ...
      <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden h-screen" v-show="active" >
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50 h-full">
          <div class="pt-5 pb-6 px-5 h-1/2">
            <div class="flex items-center justify-between">
              ...
              <div v-on:click="toggleNav" class="-mr-2">
              ...
              <div class="mt-32">
                <nav class="grid gap-y-8">
                  <a href="/vehicles" class="-m-3 p-3 {{ $page == 'vehicles' ? 'border-2 border-orange-500 rounded-2xl text-orange-500' : 'text-gray-900' }} flex items-center rounded-md hover:bg-gray-50">
                  ...
                  <a href="/add-vehicle" class="-m-3 p-3 {{ $userType == 'company' ? 'hidden' : '' }} {{ $page == 'add_vehicles' ? 'border-2 border-orange-500 rounded-2xl text-orange-500' : 'text-gray-900' }} flex items-center rounded-md hover:bg-gray-50">
                    ...
                    <span class="ml-3 text-lg font-medium"> Add Vehicle </span>
                  </a>
    
                  <a href="/register-colaborator" class="-m-3 p-3 {{ $userType == 'colaborator' ? 'hidden' : '' }} {{ $page == 'colaborators' ? 'border-2 border-orange-500 rounded-2xl text-orange-500' : 'text-gray-900' }} flex items-center rounded-md hover:bg-gray-50">
                    <svg class="h-6 w-6 text-orange-600"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  
                      <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />  <circle cx="8.5" cy="7" r="4" />  <line x1="20" y1="8" x2="20" y2="14" />  <line x1="23" y1="11" x2="17" y2="11" />
                    </svg>
                    <span class="ml-3 text-lg font-medium"> Colaborators </span>
                  </a>
                </nav>
              </div>
          </div>
