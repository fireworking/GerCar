...
app.component('login-company', require('./components/LoginCompany/LoginCompany.vue').default);

app.component('register-colaborator', require('./components/RegisterCompany/RegisterColaborator.vue').default);
