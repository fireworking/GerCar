...
@section('page')
  ...
  <register-company v-slot="{states, cities, defineCities, submit, fields, v}" v-cloak>
          ...
          <form class="space-y-6" v-on:submit.prevent="submit" action="/register-company" method="POST">
            ...
            <div class="grid gap-y-6 gap-x-4 sm:grid-cols-6">
              <div class="sm:col-span-5">
                ...
                <div class="mt-1">
                  <input v-model="fields.name" id="name" name="name" type="name" autocomplete="name" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm">
                </div>
                <error :field="v.fields.name"></error>
              ...
              <div class="sm:col-span-3">
                ...
                <div class="mt-1">
                  <input v-model="fields.cnpj" v-mask="['###.###.###-##', '##.###.###/####-##']" id="cnpj" name="cnpj" type="cnpj" autocomplete="cnpj" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm">
                </div>
                <error :field="v.fields.cnpj"></error>
              </div>
            ...
            <div>
              ...
              <error :field="v.fields.email"></error>
            </div>
            ...
            <div>
              ...
              <div class="mt-1">
                <input v-model="fields.confirmPassword" id="confirm-password" name="password" type="password" autocomplete="current-password" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm">
              </div>
              <error :field="v.fields.password"></error>
            </div>
