    ...
    <register-company v-slot="{states, cities, defineCities, submit, fields, v, serverErrors}" v-cloak>
        ...
        <div class="sm:mt-2 sm:mx-auto sm:w-full sm:max-w-xl">
            ...
            <form class="space-y-6" v-on:submit.prevent="submit" action="/register-company" method="POST">
                ...
                <div>
                    <button id="register" type="submit" class="w-full my-2 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                        Login
                    </button>
                </div>
            </form>
