...
class ColaboratorsTest extends TestCase
{
    ...
    /**
     * @dataProvider registerColaboratorData
     */
    ...
    public function registerColaboratorData(){
        return [
            [
    ...
    public function test__fill_form_has_several_validation_requirements($data, $errors, $notErrors)
    {
        $this->registerExampleCompany();
    ...
    public function test__colaborators_are_logged_in_when_registered()
    {
        ...
        $this->assertEquals('wilbur', User::find(2)->name);
    }
