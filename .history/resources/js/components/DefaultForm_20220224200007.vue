    ...
    <div class="min-h-full flex flex-col justify-center py-4 sm:py-8 sm:px-16 lg:px-20">
      <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-1 sm:mt-2 text-center text-sm text-gray-600">
          <slot name="black_subtitle"></slot>
          <a href="/login-company" class="ml-1 font-medium text-orange-600 hover:text-orange-500">
              <slot name="orange_subtitle"></slot>
          </a>
        </p>
      </div>
...
<script>
export default {
    props: ['states', 'cities', 'defineCities', 'submit', 'fields', 'v', 'serverErrors'],
}
</script>