              ...
              <thead class="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" class="px-2 sm:px-3 py-3.5 text-left text-xs sm:text-sm font-semibold text-gray-900">
                    <select v-model="color" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm">
                      <option value="all" selected>Color</option>
                      <option v-for="({color}, index) in vehicles" :key="index" :value="color">{{ color }}</option>
                    </select>
                  </th>
