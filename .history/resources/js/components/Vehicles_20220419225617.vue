...
export default {
    ...
    watch: {
      plate(newPlate, oldPlate) {
        let Vplate = this.Vplate;
        console.log(Vplate);
        Vplate = Vplate.replace(/\w/g, e => e[0].toUpperCase());
        console.log(Vplate);
        Vplate = Vplate.replace(/[A-Z]{4}/g, e => e.substring(0, 3) + '-');
        console.log(Vplate);
        Vplate = Vplate.replace(/-[A-Z]/g, e => e.substring(0, -1));
        console.log(Vplate);
        // Vplate = Vplate.replace(/^-/g, e => e.substring(0, -1));
        // console.log(Vplate);
        // Vplate = Vplate.replace(/[^\w-]/g, e => e.substring(0, -1));
        // console.log(Vplate);
        // Vplate = Vplate.replace(/\d[A-Z]{1}/g, e => e.substring(0, -1));
        // console.log(Vplate);
        this.Vplate = Vplate;
      }
    },
