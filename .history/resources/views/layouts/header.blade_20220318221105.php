        ...
        <div class="pt-5 pb-6 px-5">
          ...
          <div class="mt-16">
            <nav class="grid gap-y-8">
              ...
              <a href="/add-vehicle" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                <svg class="h-8 w-8 text-red-500"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />  <circle cx="8.5" cy="7" r="4" />  <line x1="20" y1="8" x2="20" y2="14" />  <line x1="23" y1="11" x2="17" y2="11" />
                </svg>
