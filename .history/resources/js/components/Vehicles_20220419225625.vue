...
export default {
    ...
    watch: {
      plate(newPlate, oldPlate) {
        let vlate = this.vlate;
        console.log(vlate);
        vlate = vlate.replace(/\w/g, e => e[0].toUpperCase());
        console.log(vlate);
        vlate = vlate.replace(/[A-Z]{4}/g, e => e.substring(0, 3) + '-');
        console.log(vlate);
        vlate = vlate.replace(/-[A-Z]/g, e => e.substring(0, -1));
        console.log(vlate);
        // vlate = vlate.replace(/^-/g, e => e.substring(0, -1));
        // console.log(vlate);
        // vlate = vlate.replace(/[^\w-]/g, e => e.substring(0, -1));
        // console.log(vlate);
        // vlate = vlate.replace(/\d[A-Z]{1}/g, e => e.substring(0, -1));
        // console.log(vlate);
        this.vlate = vlate;
      }
    },
