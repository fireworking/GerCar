          ...
          <form class="space-y-6" v-on:submit.prevent="submit" action="/register-company" method="POST">
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <input v-model="fields.termsOfService" id="terms-of-service" name="terms-of-service" type="checkbox" class="w-3 text-orange-600 focus:ring-orange-500 border-gray-300 rounded">
